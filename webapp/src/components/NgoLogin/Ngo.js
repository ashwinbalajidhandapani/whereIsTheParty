...
const Ngo = () => {
    ...
    useEffect(() => {
        axios.get('http://localhost:3001/users' + datavalues._id)
            .then(res => {
                console.log(res);
                setcurrentreq(res.data.request)
            });
    ...
    return (
        <div className="ngo-container">
            ...
            <div className="ngo-pageHeader">
                <h1>{datavalues.username}'s user catalog</h1>
            </div>
                    ...
                    return <ListGroup.Item
                        ...
                        >
                            <div className="ms-2 me-auto">
                                <div className="fw-bold">{val.firstname + " " + val.lastname}</div>
                                Email: {val.email} <br/>
                                Phone: {val.phone} <br/>
                                Age: {val.age}
                            </div>
            ...
            {/* <div className="cards-ngo-layout">
                {data.map(val, key) => {
                    return (
                <div key={key} className="req-cards">
                    sad
                </div>)
                })}
