...
function LoginPage() {
    ...
    async function onSubmit(e) {
        ...
        try {
            ...
            setError("INVALID EMAIL OR PASSWORD IN");
            ...
            <div className="left-side">
                <form className="data-form" onSubmit={onSubmit}>
                    ...
                    <div className="form-element form-user">
                        <Link to="/register" className="form-user-redirect">Register</Link>
                    </div>
                </form>
            </div>

            <div className="right-side">
                <img className="header-image" src="assets/party-wallpaper-2.jpeg"></img>
            </div>
        </div>
